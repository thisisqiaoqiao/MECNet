...
from .loss import CharbonnierLoss,AMPLoss,PhaLoss,FourierLoss
from .loss_new import SSIMLoss,VGGLoss
...
class SIEN_Model(BaseModel):
    ...
    def optimize_parameters(self, step):
        ...
        out,feature,pyr_A= self.netG(self.var_L)
        gt = self.real_H
        ...
        if self.opt['train']['augment']:
            ...
            _, augfeature,_ = self.netG(auginput)
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            out, x_pre,_= self.netG(self.var_L)
            self.fake_H = out
